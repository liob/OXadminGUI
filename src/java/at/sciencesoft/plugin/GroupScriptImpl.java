 ...
 */
public class GroupScriptImpl implements GroupIface {

    public GroupScriptImpl(HashMap<Plugin.ACTION, Script> actionMap, String errorPath, String msgPath) {
    ...
    public ResultSet create(boolean isPost,boolean isSuccess, int contextID, Credentials auth, String name, String displayName, String members, ParamMap map, ResultSet rs,Group group) {
        ...
        if (call) {
            ...
            al.add(Plugin.PLUGIN.GROUP.name());
